...
export const CompactTimeline = memo(function CompactTimeline({ resume, palette }: Props) {
  ...
  const css = `
    .ct-root { font-family: 'Geist Variable', 'Inter', sans-serif; color: #1f2937; font-size: 9.1pt; line-height: 1.4; overflow-wrap: break-word; word-break: normal; hyphens: manual; }
    ...
    .ct-summary { font-size: 8.8pt; line-height: 1.5; color: #1e293b; text-align: justify; hyphens: manual; overflow-wrap: break-word; }
    ...
    .ct-skill-label > :not(svg) { min-width: 0; overflow-wrap: anywhere; }
    ...
    .ct-edumeta { color: #6b7280; font-size: 8pt; font-style: italic; max-width: 100%; min-width: 0; }
        ...
        <div className="ct-two">
          {resume.skills.map((g) => (
            <div className="ct-skill-group" key={g.id}>
              <span className="ct-skill-label" data-keep-with-next="true">
                {g.label}:{" "}
              </span>
        ...
        <div className="ct-proj-grid">
          {resume.projects.map((p) => (
            <div className="ct-proj" key={p.id}>
              <div className="ct-projname" data-keep-with-next="true">
                {p.name}
              </div>
              {p.description && (
                <>
                  <div className="ct-proj-label" data-keep-with-next="true">
                    About Project
                  </div>
