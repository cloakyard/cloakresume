...
export const ExecutiveSerif = memo(function ExecutiveSerif({ resume, palette }: Props) {
  ...
  const css = `
    .es-root { font-family: 'Geist Variable', 'Inter', sans-serif; color: #1f2937; font-size: 9.4pt; line-height: 1.5; overflow-wrap: normal; word-break: normal; hyphens: manual; }
    ...
    .es-name { font-family: 'Instrument Serif', 'Iowan Old Style', Georgia, serif; font-size: 26pt; font-weight: 700; letter-spacing: 0.5px; color: #111827; margin: 0; overflow-wrap: normal; }
    .es-title { font-size: 10pt; color: ${palette.primary700}; letter-spacing: 3px; text-transform: uppercase; margin-top: 2mm; font-weight: 600; overflow-wrap: normal; }
    ...
    .es-summary { font-size: 9.5pt; line-height: 1.65; text-align: justify; color: #1e293b; hyphens: manual; overflow-wrap: normal; }
    ...
    .es-jobtitle { font-size: 10.5pt; font-weight: 700; color: #111827; font-family: 'Instrument Serif', 'Iowan Old Style', Georgia, serif; min-width: 0; flex: 1 1 auto; overflow-wrap: normal; }
    .es-jobmeta { font-size: 8.8pt; color: #6b7280; font-style: italic; flex-shrink: 0; }
    .es-jobco { font-size: 9.5pt; color: ${palette.primary700}; font-weight: 600; margin-bottom: 1.5mm; overflow-wrap: normal; }
    .es-job ul { list-style: none; padding: 0; margin: 0; }
    .es-job li { font-size: 9.3pt; line-height: 1.5; padding-left: 5mm; position: relative; margin-bottom: 1mm; overflow-wrap: normal; }
    ...
    .es-ul-bullet li { font-size: 9.3pt; line-height: 1.5; padding-left: 5mm; position: relative; margin-bottom: 1mm; overflow-wrap: normal; }
    ...
    .es-skill-label { color: ${palette.primary700}; font-weight: 700; font-variant: small-caps; letter-spacing: 0.5px; display: flex; align-items: center; gap: 1.8mm; min-width: 0; overflow-wrap: normal; }
    ...
    .es-edutitle { font-weight: 700; color: #111827; font-size: 10pt; overflow-wrap: normal; }
    .es-eduschool { color: ${palette.primary700}; font-size: 9pt; overflow-wrap: normal; }
    ...
    .es-item { font-size: 9pt; margin-bottom: 1.6mm; overflow-wrap: normal; }
    .es-item strong { color: #111827; overflow-wrap: normal; }
    ...
    .es-projname { font-family: 'Instrument Serif', 'Iowan Old Style', Georgia, serif; font-size: 10.6pt; font-weight: 700; color: #111827; margin-bottom: 1mm; overflow-wrap: normal; }
    .es-proj-label { font-family: 'Geist Variable', 'Inter', sans-serif; font-size: 8pt; font-weight: 700; color: ${palette.primary700}; text-transform: uppercase; letter-spacing: 1px; margin: 1.2mm 0 0.5mm; }
    .es-proj-bullets { list-style: none; padding: 0; margin: 0 0 0.8mm; }
    .es-proj-bullets li { font-size: 9pt; line-height: 1.5; padding-left: 4mm; position: relative; margin-bottom: 0.6mm; color: #27272a; overflow-wrap: normal; }
    ...
    .es-pill { display: inline-block; border: 1px solid ${palette.primary200}; color: ${palette.primary900}; padding: 0.3mm 2mm; margin: 0.3mm; border-radius: 3px; font-size: 8pt; font-weight: 600; background: ${palette.primary50}; max-width: 100%; overflow-wrap: normal; word-break: break-word; }
  `;
