...
export function ExecutiveSerif({ resume, palette }: Props) {
  ...
  const css = `
    .es-root { font-family: 'Geist', 'Inter', sans-serif; color: #1f2937; font-size: 9.4pt; line-height: 1.5; padding: 16mm 18mm; }
    ...
    .es-h2 { font-family: 'Instrument Serif', 'Iowan Old Style', Georgia, serif; font-size: 14pt; font-weight: 700; color: #111827; text-align: center; margin: 5mm 0 4mm; position: relative; }
    ...
    .es-section { margin-bottom: 5mm; page-break-inside: avoid; }
    .es-summary { font-size: 9.5pt; line-height: 1.65; text-align: justify; color: #1e293b; }
    .es-job { margin-bottom: 4mm; page-break-inside: avoid; }
    ...
    .es-skill-group { margin-bottom: 1.8mm; font-size: 9.2pt; display: grid; grid-template-columns: 42mm 1fr; gap: 3mm; }
    ...
    .es-edu { display: flex; justify-content: space-between; margin-bottom: 1mm; align-items: baseline; }
    ...
    .es-proj { margin-bottom: 3mm; padding-bottom: 2.5mm; border-bottom: 1px dashed #e5e7eb; page-break-inside: avoid; }
        ...
        {resume.experience.length > 0 && (
          <section className="es-section">
            ...
            {resume.experience.map((job) => (
              <div className="es-job" key={job.id}>
        ...
        {resume.skills.length > 0 && (
          <section className="es-section">
            ...
            {resume.skills.map((g) => {
              ...
              return (
                <div key={g.id} className="es-skill-group">
        ...
        {resume.projects.length > 0 && (
          <section className="es-section">
            ...
            {resume.projects.map((p) => (
              <div className="es-proj" key={p.id}>
        ...
        {resume.education.length > 0 && (
          <section className="es-section">
            ...
            {resume.education.map((ed) => (
              <div className="es-edu" key={ed.id}>
                <div>
