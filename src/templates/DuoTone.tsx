...
export function DuoTone({ resume, palette }: Props) {
  ...
  const css = `
    ...
    .dt-page { display: grid; grid-template-columns: 78mm 1fr; min-height: 297mm; }
    .dt-left { background: ${palette.primary900}; color: ${palette.primaryText}; padding: 16mm 10mm 12mm; position: relative; overflow: hidden; }
    ...
    .dt-right { padding: 14mm 14mm 10mm; }
    ...
    .dt-h2 { font-size: 11pt; font-weight: 800; color: #0a0a0a; text-transform: uppercase; letter-spacing: 1.6px; margin: 0 0 3mm; display: flex; align-items: center; gap: 3mm; }
    .dt-h2::before { content: ""; width: 3mm; height: 3mm; background: ${palette.primary600}; border-radius: 50%; flex-shrink: 0; }
    .dt-section { margin-bottom: 6mm; page-break-inside: avoid; }
    .dt-summary { font-size: 9.8pt; line-height: 1.6; color: #1f2937; font-weight: 400; }
    .dt-job { margin-bottom: 4mm; page-break-inside: avoid; position: relative; padding-left: 5mm; }
    ...
    .dt-proj { display: grid; grid-template-columns: 1fr 1fr; gap: 3mm; margin-bottom: 2.5mm; }
    .dt-proj-card { border: 1px solid #e5e7eb; border-top: 3px solid ${palette.primary600}; border-radius: 2px; padding: 2.5mm 3mm; background: #fafafa; page-break-inside: avoid; }
    ...
    .dt-edu { display: flex; justify-content: space-between; align-items: baseline; margin-bottom: 1.5mm; gap: 4mm; }
        ...
        <div className="dt-page">
          ...
          <main className="dt-right">
            ...
            {resume.experience.length > 0 && (
              <section className="dt-section">
                <h2 className="dt-h2">Experience</h2>
                {resume.experience.map((job) => (
                  <div className="dt-job" key={job.id}>
                ...
                <div className="dt-proj">
                  {resume.projects.map((p) => (
                    <div className="dt-proj-card" key={p.id}>
                      ...
                      {p.stack.length > 0 && (
                        <div className="dt-proj-stack">{p.stack.join(" · ")}</div>
                      )}
                    </div>
                  ))}
                </div>
            ...
            {resume.education.length > 0 && (
              <section className="dt-section">
                <h2 className="dt-h2">Education</h2>
                {resume.education.map((ed) => (
                  <div className="dt-edu" key={ed.id}>
                    <div>
