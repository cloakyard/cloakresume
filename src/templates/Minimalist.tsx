...
export const Minimalist = memo(function Minimalist({ resume, palette }: Props) {
  const css = `
    .ml-root { font-family: 'Geist Variable', 'Inter', sans-serif; color: #1a1a1a; font-size: 9.8pt; line-height: 1.6; overflow-wrap: normal; word-break: normal; hyphens: manual; }
    .ml-head { margin-bottom: 8mm; }
    .ml-name { font-size: 24pt; font-weight: 500; color: #0a0a0a; letter-spacing: -0.6px; margin: 0; line-height: 1.05; overflow-wrap: normal; }
    .ml-title { font-size: 10.5pt; color: #525252; margin-top: 2mm; font-weight: 400; letter-spacing: 0.2px; overflow-wrap: normal; }
    ...
    .ml-summary { font-size: 10pt; line-height: 1.7; color: #262626; max-width: 168mm; hyphens: manual; overflow-wrap: normal; }
    ...
    .ml-jobtitle { font-size: 10.4pt; font-weight: 600; color: #0a0a0a; min-width: 0; flex: 1 1 auto; overflow-wrap: normal; }
    .ml-jobmeta { font-size: 9pt; color: #737373; font-variant-numeric: tabular-nums; flex-shrink: 0; }
    .ml-jobco { font-size: 9.6pt; color: #525252; margin-bottom: 1.8mm; font-style: italic; overflow-wrap: normal; }
    .ml-job ul { list-style: none; padding: 0; margin: 0; }
    .ml-job li { font-size: 9.6pt; line-height: 1.55; padding-left: 4.5mm; position: relative; margin-bottom: 1mm; color: #262626; overflow-wrap: normal; }
    .ml-job li::before { content: "—"; position: absolute; left: 0; color: #a3a3a3; }
    .ml-ul-bullet { list-style: none; padding: 0; margin: 0; }
    .ml-ul-bullet li { font-size: 9.6pt; line-height: 1.55; padding-left: 4.5mm; position: relative; margin-bottom: 1mm; color: #262626; overflow-wrap: normal; }
    ...
    .ml-skill-label { color: #0a0a0a; font-weight: 600; min-width: 0; overflow-wrap: normal; }
    ...
    .ml-edu-title, .ml-proj-name { font-size: 10pt; font-weight: 600; color: #0a0a0a; min-width: 0; flex: 1 1 auto; overflow-wrap: normal; }
    .ml-edu-school { font-size: 9.4pt; color: #525252; font-style: italic; overflow-wrap: normal; }
    .ml-edu-meta, .ml-proj-meta { font-size: 9pt; color: #737373; font-variant-numeric: tabular-nums; flex-shrink: 0; overflow-wrap: normal; }
    ...
    .ml-proj-bullets li { font-size: 9.4pt; line-height: 1.5; padding-left: 4mm; position: relative; margin-bottom: 0.5mm; color: #262626; overflow-wrap: normal; }
    ...
    .ml-inline { font-size: 9.6pt; color: #262626; overflow-wrap: normal; }
    .ml-inline strong { color: #0a0a0a; font-weight: 600; overflow-wrap: normal; }
