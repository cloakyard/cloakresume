...
export const GradientHeader = memo(function GradientHeader({ resume, palette }: Props) {
  ...
  const css = `
    .gh-root { font-family: 'Geist Variable', 'Inter', sans-serif; color: #1f2937; font-size: 9.4pt; line-height: 1.5; overflow-wrap: normal; word-break: normal; hyphens: manual; }
    ...
    .gh-name { font-size: 20pt; font-weight: 700; letter-spacing: -0.3px; line-height: 1.05; margin: 0; overflow-wrap: normal; }
    .gh-title { font-size: 10.2pt; margin-top: 1.2mm; letter-spacing: 1px; text-transform: uppercase; opacity: 0.92; font-weight: 600; overflow-wrap: normal; }
    ...
    .gh-h2 { font-size: 9.4pt; text-transform: uppercase; letter-spacing: 1.4px; color: ${palette.primary700}; font-weight: 700; margin: 5.5mm 0 2.5mm; display: flex; align-items: center; gap: 3mm; break-after: avoid; page-break-after: avoid; overflow-wrap: normal; }
    .gh-h2::before { content: ""; width: 8mm; height: 3px; background: ${palette.primary600}; border-radius: 1.5px; flex-shrink: 0; }
    .gh-summary { font-size: 9.4pt; line-height: 1.55; color: #1e293b; overflow-wrap: normal; }
    ...
    .gh-jobmeta { font-size: 8.4pt; color: #6b7280; overflow-wrap: normal; }
    .gh-jobmeta .co { color: ${palette.primary700}; font-weight: 700; font-size: 9pt; display: block; margin-bottom: 0.5mm; overflow-wrap: normal; }
    .gh-jobmeta .dates { display: block; margin-top: 0.5mm; }
    .gh-jobtitle { font-size: 10pt; font-weight: 700; color: #111827; margin-bottom: 1.2mm; overflow-wrap: normal; }
    .gh-job ul { list-style: none; padding: 0; margin: 0; }
    .gh-job li { font-size: 8.9pt; line-height: 1.45; padding-left: 5mm; position: relative; margin-bottom: 1mm; color: #27272a; overflow-wrap: normal; }
    ...
    .gh-ul-row li { font-size: 8.9pt; line-height: 1.45; padding-left: 5mm; position: relative; margin-bottom: 1mm; color: #27272a; overflow-wrap: normal; }
    ...
    .gh-ul-bullet li { font-size: 8.9pt; line-height: 1.45; padding-left: 5mm; position: relative; margin-bottom: 1mm; color: #27272a; overflow-wrap: normal; }
    ...
    .gh-chip { background: linear-gradient(135deg, ${palette.primary50}, ${palette.primary100}); border: 1px solid ${palette.primary200}; color: ${palette.primary900}; padding: 0.6mm 2.4mm; border-radius: 999px; font-size: 8pt; font-weight: 600; max-width: 100%; overflow-wrap: normal; word-break: break-word; }
    ...
    .gh-skill-label { color: ${palette.primary700}; font-weight: 700; display: flex; align-items: center; gap: 1.8mm; min-width: 0; overflow-wrap: normal; }
    ...
    .gh-projname { font-size: 9.6pt; font-weight: 700; color: #111827; min-width: 0; overflow-wrap: normal; }
    .gh-projdesc { font-size: 8.8pt; color: #374151; margin-top: 0.8mm; line-height: 1.45; overflow-wrap: normal; }
    ...
    .gh-proj-bullets li { font-size: 8.8pt; line-height: 1.45; padding-left: 4mm; position: relative; margin-bottom: 0.5mm; color: #374151; overflow-wrap: normal; }
    ...
    .gh-edutitle { font-weight: 700; color: #111827; font-size: 9.3pt; overflow-wrap: normal; }
    .gh-eduschool { color: ${palette.primary700}; font-size: 8.8pt; overflow-wrap: normal; }
    ...
    .gh-cert { font-size: 8.6pt; margin-bottom: 1.5mm; overflow-wrap: normal; }
    .gh-cert strong { color: #111827; display: block; overflow-wrap: normal; }
    .gh-kv { font-size: 8.6pt; margin-bottom: 1.2mm; overflow-wrap: normal; }
    .gh-kv strong { color: #111827; overflow-wrap: normal; }
  `;
