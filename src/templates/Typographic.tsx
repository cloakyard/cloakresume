...
export function Typographic({ resume, palette }: Props) {
  const css = `
    .tg-root { font-family: 'Geist', 'Inter', sans-serif; color: #111827; font-size: 9.4pt; line-height: 1.5; padding: 16mm 18mm; }
    ...
    .tg-section { display: grid; grid-template-columns: 32mm 1fr; gap: 6mm; margin-bottom: 7mm; page-break-inside: avoid; }
    ...
    .tg-job { display: grid; grid-template-columns: 32mm 1fr; gap: 4mm; margin-bottom: 4.5mm; page-break-inside: avoid; }
    ...
    .tg-proj { margin-bottom: 3.5mm; page-break-inside: avoid; }
        ...
        {resume.profile.summary && (
          <section className="tg-section">
            <div className="tg-marker">
              <div className="tg-marker-num">{next()}</div>
