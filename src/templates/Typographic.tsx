...
export const Typographic = memo(function Typographic({ resume, palette }: Props) {
  const css = `
    .tg-root { font-family: 'Geist Variable', 'Inter', sans-serif; color: #111827; font-size: 9.4pt; line-height: 1.5; overflow-wrap: break-word; word-break: normal; hyphens: manual; }
    ...
    .tg-summary { font-size: 10.4pt; line-height: 1.6; color: #111827; max-width: 148mm; font-weight: 400; letter-spacing: -0.1px; hyphens: manual; overflow-wrap: break-word; }
    ...
    .tg-skill-label > :not(svg) { min-width: 0; overflow-wrap: anywhere; }
    ...
    .tg-edu-meta { font-size: 8.8pt; color: #6b7280; font-variant-numeric: tabular-nums; white-space: normal; flex-shrink: 0; max-width: 100%; min-width: 0; }
          ...
          <div className="tg-grid-2">
            {resume.skills.map((g) => (
              <div className="tg-skill" key={g.id}>
                <div className="tg-skill-label" data-keep-with-next="true">
                  {g.label}
                </div>
        ...
        <section className={className} key={`proj-${p.id}`}>
          ...
          <div className={isFirst ? "tg-body" : "tg-body-cont"}>
            <div className="tg-proj">
              <div className="tg-proj-head" data-keep-with-next="true">
                <div className="tg-proj-name" data-keep-with-next="true">
                  {p.name}
                </div>
              </div>
              {p.description && (
                <>
                  <div className="tg-proj-label" data-keep-with-next="true">
                    About Project
                  </div>
