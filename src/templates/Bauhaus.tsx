...
export const Bauhaus = memo(function Bauhaus({ resume, palette }: Props) {
  ...
  const css = `
    .bh-root { font-family: 'Geist Variable', 'Inter', sans-serif; color: #111827; font-size: 9.4pt; line-height: 1.5; overflow-wrap: normal; word-break: normal; hyphens: manual; }
    ...
    .bh-name { font-size: 22pt; font-weight: 900; letter-spacing: -0.8px; line-height: 1; margin: 0; overflow-wrap: normal; min-width: 0; }
    ...
    .bh-title { font-size: 9.6pt; font-weight: 800; text-transform: uppercase; letter-spacing: 2.2px; color: ${palette.primary900}; overflow-wrap: normal; min-width: 0; }
    ...
    .bh-h2 { display: flex; align-items: center; gap: 2.5mm; font-size: 10pt; font-weight: 900; text-transform: uppercase; letter-spacing: 2px; color: #0a0a0a; margin: 5mm 0 3mm; padding-bottom: 1.4mm; border-bottom: 2px solid #0a0a0a; break-after: avoid; page-break-after: avoid; overflow-wrap: normal; }
    ...
    .bh-summary { font-size: 10pt; line-height: 1.6; color: #1f2937; padding: 3mm 4mm; background: ${palette.primary50}; border-left: 4px solid ${palette.primary600}; overflow-wrap: normal; }
    ...
    .bh-jobtitle { font-size: 10.4pt; font-weight: 800; color: #0a0a0a; letter-spacing: -0.15px; min-width: 0; flex: 1 1 auto; overflow-wrap: normal; }
    ...
    .bh-jobco { font-size: 9.2pt; color: ${palette.primary700}; font-weight: 800; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 1.6mm; overflow-wrap: normal; }
    ...
    .bh-job li { font-size: 9pt; line-height: 1.5; padding-left: 5mm; position: relative; margin-bottom: 0.8mm; color: #1f2937; overflow-wrap: normal; }
    ...
    .bh-ul-bullet li { font-size: 9pt; line-height: 1.5; padding-left: 5mm; position: relative; margin-bottom: 0.8mm; color: #1f2937; overflow-wrap: normal; }
    ...
    .bh-skill-label { font-size: 8.6pt; font-weight: 800; text-transform: uppercase; letter-spacing: 1.4px; color: #0a0a0a; margin-bottom: 0.6mm; display: flex; align-items: center; gap: 1.6mm; overflow-wrap: normal; }
    ...
    .bh-proj-name { font-size: 10pt; font-weight: 800; color: #0a0a0a; overflow-wrap: normal; }
    ...
    .bh-proj-bullets li { font-size: 8.8pt; line-height: 1.5; padding-left: 5mm; position: relative; margin-bottom: 0.6mm; color: #1f2937; overflow-wrap: normal; }
    ...
    .bh-edu-title { font-size: 9.6pt; font-weight: 800; color: #0a0a0a; overflow-wrap: normal; }
    .bh-edu-school { font-size: 8.8pt; color: ${palette.primary700}; font-weight: 700; overflow-wrap: normal; }
    .bh-edu-meta { font-size: 8.4pt; color: #0a0a0a; font-variant-numeric: tabular-nums; white-space: nowrap; font-weight: 700; }
    .bh-edu-detail { font-size: 8.2pt; color: #6b7280; font-style: italic; margin-top: 0.3mm; grid-column: 1 / -1; overflow-wrap: normal; }

    .bh-item { font-size: 8.8pt; margin-bottom: 1.4mm; color: #1f2937; line-height: 1.45; padding-left: 4mm; position: relative; overflow-wrap: normal; }
    ...
    .bh-item strong { color: #0a0a0a; font-weight: 800; overflow-wrap: normal; }
    ...
    .bh-kv { font-size: 8.6pt; margin-bottom: 1mm; color: #1f2937; overflow-wrap: normal; }
    .bh-kv strong { color: #0a0a0a; font-weight: 800; text-transform: uppercase; letter-spacing: 0.6px; overflow-wrap: normal; }
  `;
