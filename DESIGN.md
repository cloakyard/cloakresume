...
at a `0.6rem` gap—the exact CloakPDF header geometry. The Ft5 statement footer does
not repeat the lockup; it closes with the product/family kicker and provenance line.
Never redraw, crop, stretch, or independently resize the wordmark.
