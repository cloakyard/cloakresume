...
|   4 | `src/components/BrandLogo.tsx`                    | Aligned | Full-bleed `logo.svg` in the canonical 40px circular clip, 0.6rem lockup gap, exact CloakPDF Archivo 800 metrics, and accessible home label.            |
...
|  13 | `src/components/Layout.tsx`                       | Aligned | 64px task-only editor header, 72px rail, token-driven 328/384px panel, 50:50 mobile proof/workspace split, inline picker, and one editor h1.            |
